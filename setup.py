...
exec(open("zillion_covid_19/version.py").read())

setup(
    name="zillion_covid_19",
    description="Use Zillion to analyze COVID-19 data",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/totalhack/zillion_covid_19",
    author="totalhack",
    ...
    scripts=find_deploy_scripts(
        "zillion_covid_19", ["\\*.py", "\\*.sh", "\\*.sql"], ["__init__"]
    ),
